class RegistrosController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html
      format.csv { send_data @registros.to_csv }
    end
  end
  ...
  private
    ...
    def registro_params
      params.require(:registro).permit(:Folio, :Soporte, :No_Referencia, :Fecha_Recepcion, :Fecha_documento, :Destinatario, :Remitente, :Asunto, :Se_Turno_A, :Documento, :Anexos, :Instruccion, :Fecha_Limite)
    end
end
