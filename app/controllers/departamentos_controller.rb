  ...
  def create
    ...
    respond_to do |format|
      if @departamento.save
        format.html { redirect_to user_index_path, notice: 'Se ha asignado departamento.' }
  ...
  def update
    respond_to do |format|
      if @departamento.update(departamento_params)
        format.html { redirect_to user_index_path, notice: 'Se cambio departamento con exito.' }
