...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post departamentos_url, params: { departamento: { nombre: @departamento.nombre, user_id: @departamento.user_id } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { nombre: @departamento.nombre, user_id: @departamento.user_id } }
